...
class PreThemeEdit extends StatefulWidget {
  final List<SongModel> data;
  const PreThemeEdit({Key? key, required this.data}) : super(key: key);
  @override
  State<PreThemeEdit> createState() => _PreThemeEditState();
}

class _PreThemeEditState extends State<PreThemeEdit> {
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          ...
                          style: ourStyle(
                            color:
                                downColor == "White" ? bgDarkColor : whiteColor,
                            size: 20,
                          ),
                          textAlign: TextAlign.center,
                          overflow: TextOverflow.ellipsis,
